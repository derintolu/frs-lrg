  ...
  const renderBiolinkTab = () => (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 min-h-[800px] overflow-visible grid-rows-[1fr]">
      ...
      <div className="lg:col-span-2 min-h-[800px]">
        <Card className="shadow-lg border-l-4 rounded-lg border-l-blue-500 h-full">
  ...
  return (
    <Tabs value={activeSection} onValueChange={(value) => setActiveSection(value as 'digital' | 'social-print' | 'partner')} className="flex flex-col">
      <div className="min-h-screen bg-[var(--brand-page-background)]">
        ...
        {/* Main Content */}
        <main className="px-4 pb-4" style={{ paddingTop: '180px' }}>
          {error && (
            <div className="mb-6">
              <ErrorAlert
                type="error"
...
function LandingPagesOnly({ userRole, userId, currentUser }: LandingPagesOnlyProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Leads Management - Only show for loan officers */}
      {userRole === 'loan-officer' && (
        <Card className="border-[var(--brand-powder-blue)]">
          <CardHeader>
