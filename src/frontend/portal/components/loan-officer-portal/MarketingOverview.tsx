...
// Full page navigation for WordPress pages (not React Router)
    ...
    <div className="w-full min-h-screen p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div onClick={() => goToPage('marketing/calendar')} className="cursor-pointer lg:col-span-2">
            <BookingCalendarCard />
          </div>

          <div onClick={() => goToPage('marketing/landing-pages')} className="cursor-pointer lg:col-span-1">
            <LandingPagesCard />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div onClick={() => goToPage('marketing/brand-guide')} className="cursor-pointer lg:col-span-1">
            <BrandGuideCard />
          </div>

          <div onClick={() => goToPage('marketing/orders')} className="cursor-pointer lg:col-span-2">
