...
import { FloatingInput } from '../frontend/portal/components/ui/floating-input';
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '../frontend/portal/components/ui/dialog';
    ...
    <div className="w-full max-w-7xl mx-auto p-6 font-sans">
      ...
      <div className="w-full">
        <PageHeader
          ...
          iconBgColor={`linear-gradient(135deg, ${gradientStart} 0%, ${gradientEnd} 100%)`}
        />
